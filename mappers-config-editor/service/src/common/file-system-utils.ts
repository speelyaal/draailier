...
export default class FileSystemUtils {
    ...
    public static DraailierDirName: string = process.env.THAALAM_DIR_NAME ?? '';
    ...
    public static getDraailierConfigFilePath(): string {
        return path.join(FileSystemUtils.GetMappersRootDirectoryPath(),
            FileSystemUtils.DraailierDirName, FileSystemUtils.ConfigFileName);
    }

    public static getDraailierTemplateDirPath(): string {
        return path.join(FileSystemUtils.GetMappersRootDirectoryPath(),
            FileSystemUtils.DraailierDirName, "template");
    }
    ...
    public static copyTemplateFilesForCloudProvider(cloudProviderId: string): boolean {
        try {
            ...
            const templateDirPath = FileSystemUtils.getDraailierTemplateDirPath();
