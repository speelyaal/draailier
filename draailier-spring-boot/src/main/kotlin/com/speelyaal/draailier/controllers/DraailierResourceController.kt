...
class DraailierResourceController(var restHelper: RestHelper){


    private val LOG: Logger = LogManager.getLogger(DraailierResourceController::class.java)
